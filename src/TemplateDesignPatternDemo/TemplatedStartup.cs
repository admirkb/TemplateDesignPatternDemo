...
using TemplateDesignPatternDemo.Models;
using TemplateDesignPatternDemo.Services;

namespace TemplateDesignPatternDemo
{
    public class TemplatedStartup
    {
        ...
        public TemplatedStartup(IHostingEnvironment env)
        {
        ...
        public static void Main(string[] args) => WebApplication.Run<TemplatedStartup>(args);
    }
}
